  ...
  return (
    <div className="h-screen sticky top-0 border-r-1">
      ...
      <div className="mt-52 mr-4">
        ...
        <div className="mt-3 py-3 px-2">
          <Icon icon="majesticons:paper-fold-text-line" width="30" height="30" />
        </div>

        <div className="my-10 border-b-1 opacity-30"></div>

        <div className="mt-3 py-3 px-2">
          <Icon icon="dashicons:welcome-write-blog" width="30" height="30" />
        </div>
      </div>

      <div className="mt-52 mr-4">
        <div className="py-2 px-2">
          <Icon icon="bxs:user-circle" width="30" height="30" />
        </div>
      </div>
    </div>
  )
