    ...
    return (
        <nav className="nav flex flex-wrap items-center justify-between px-4">
            ...
            <input
                ...
                type="checkbox"
                id="menu-toggle"
                defaultChecked={!flyer.toString()}
                onClick={(e) => setFlyer(!flyer)}
            />
            <label htmlFor="menu-toggle" className='pointer-cursor md:hidden block'>
                {
                    flyer === true ? (
                        <svg height="15" viewBox="0 0 376.49067 376.49067" width="15"
                        ...
                        <svg height="20" viewBox="-192 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg">
                            <g fill="#000" z>
                                <path
                            ...
                            <path
                                d="m64 320c-35.285156 0-64-28.714844-64-64s28.714844-64 64-64 64 28.714844 64 64-28.714844 64-64 64zm0-96c-17.644531 0-32 14.355469-32 32s14.355469 32 32 32 32-14.355469 32-32-14.355469-32-32-32zm0 0"/>
                            <path
                                d="m64 128c-35.285156 0-64-28.714844-64-64s28.714844-64 64-64 64 28.714844 64 64-28.714844 64-64 64zm0-96c-17.644531 0-32 14.355469-32 32s14.355469 32 32 32 32-14.355469 32-32-14.355469-32-32-32zm0 0"/>
                            <path
                                d="m64 512c-35.285156 0-64-28.714844-64-64s28.714844-64 64-64 64 28.714844 64 64-28.714844 64-64 64zm0-96c-17.644531 0-32 14.355469-32 32s14.355469 32 32 32 32-14.355469 32-32-14.355469-32-32-32zm0 0"/>
                        </svg>
                    )
                }
                                        ...
                                        <Link href="/auth/signin">
                                            <div className="mx-3 rounded-full px-0 bg-gray-300 relative w-8 h-8">
                                                <img src="http://source.unsplash.com/100x100/?woman"
                                                     className={"rounded-full bg-cover bg-no-repeat"} alt={""}/>
