        ...
        <div className="flex flex-wrap w-full h-96 mb-10 mt-4 md:mt-0 md:max-h-60">
            <div className="lg:w-1/3 max-h-30 md:w-2/4 sm:w-full flex justify-around border-2">
                ...
                <div className="w-4/5 py-2">
                    <p className="text-base font-semibold capitalize">lorem ipsum dolor sit amet consectetur elit
                        kambing hitam</p>
                    <p className="text-sm text-ellipsis line-clamp-2 w-9/12 py-1">Contrary to popular belief, Lorem
